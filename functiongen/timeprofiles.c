...
void main(int argc, char *argv[])
{
    ...
    printf("SEQUENTIAL Train from table in %lf seconds with %d samples: final velocity = %lf, final position = %lf\n", 
    ...
    printf("SEQUENTIAL 2 PHASE Train from table with %d samples: final velocity = %lf, final position = %lf\n", 
    ...
    printf("DESIGN for PARALLEL: Train from table with %d samples: final velocity = %lf, final position = %lf\n", 
	    tsize, VelProfile[tsize-1], PosProfile[tsize-1]);
}
